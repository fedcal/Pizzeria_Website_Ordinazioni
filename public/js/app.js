...
function initAdmin() {
  ...
  function generateMarkup(orders) {
    return orders.map(function (order) {
      return "\n                <tr>\n                    <td class=\"border px-4 py-2 text-green-900\">\n                        <p>".concat(order._id, "</p>\n                        <div>").concat(renderItems(order.items), "</div>\n                    </td>\n                    <td class=\"border px-4 py-2\"> ").concat(order.customerId.name, "</td>\n                    <td class=\"border px-4 py-2\">").concat(order.note, "</td>\n                    <td   class=\"border px-4 py-2\">\n                        <div class=\"inline-block relative w-64\">\n                            <form action=\"/admin/orders/status\" method=\"POST\">\n                                <input type=\"hidden\" name=\"orderId\" value=\"").concat(order._id, "\">\n                                <select name=\"status\" onchange=\"this.form.submit()\" class=\"block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline\">\n                                    <option value=\"order_placed\" ").concat(order.status === 'order_placed' ? 'selected' : '', "> Nuovo ordine </option>\n                                    <option value=\"confirmed\" ").concat(order.status === 'confirmed' ? 'selected' : '', "> Confermato </option>\n                                    <option value=\"prepared\" ").concat(order.status === 'prepared' ? 'selected' : '', "> In preparazione </option>\n                                    <option value=\"daRitirare\" ").concat(order.status === 'daRitirare' ? 'selected' : '', "> Pronto per il ritiro </option>\n                                    <option value=\"completed\" ").concat(order.status === 'completed' ? 'selected' : '', "> Completato </option>\n                                    <option value=\"canceled\" ").concat(order.status === 'cancelled' ? 'selected' : '', "> Rifiutare </option>\n                                </select>\n                            </form>\n                            <div class=\"pointer-events-none absolute inset-y-0 right-0 flax items-center px-2 text-gray-700\">\n                                <svg class=\"fill-current h-4 w-4\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\" 0 0 20 20\">\n                                    <path d=\"M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z\"/>\n                                </svg>\n                            </div>\n                        </div>\n                    </td>\n                    <td class=\"border px-4 py-2\"> ").concat(order.date, " </td>\n                    <td class=\"border px-4 py-2\"> ").concat(moment__WEBPACK_IMPORTED_MODULE_1___default()(order.createdAt).format('hh:mm A'), " </td>\n                </tr>");
    }).join('');
  }
}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkPizzeriaConOrdinazioni"] = self["webpackChunkPizzeriaConOrdinazioni"] || [];
